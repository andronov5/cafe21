export const phone = "tel:+13032973651";
export const directions = "https://www.google.com/maps/search/?api=1&query=Cafe+21+Express+999+18th+St+Suite+101+Denver+CO+80202";
export const foods = [
  { name: "Philly Cheesesteak", tag: "THE LUNCH-BREAK CLASSIC", price: "8.99", image: "Beef-Philly-Cheesesteak-3.webp", alt: "Cafe 21's Philly cheesesteak with melted cheese", description: "A warm, cheesy lunch-break favorite." },
...
export const moreLunch = [
  ["French Dip", "8.69"], ["Garden Burger", "6.39"], ["Chicken Fried Rice", "10.59"], ["Chicken Teriyaki & Egg Rolls", "12.59"], ["Shrimp Lo Mein", "11.59"], ["Salad Bar · 38 oz", "9.49"], ["Egg Rolls", "2.99"], ["French Fries", "2.99"],
];
