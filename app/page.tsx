...
import { HeroShowcase, SiteMotion } from "./wow";
      ...
      <main id="main">
        <section className="hero" aria-labelledby="hero-title">
          <div className="hero-copy">
            ...
            <h1 id="hero-title"><span className="hero-line"><span>BIG FLAVOR.</span></span><span className="hero-line"><span>SMALL <i className="headline-star" aria-hidden="true">✳</i></span></span><span className="hero-line"><span className="outline-word">BREAK.</span></span></h1>
        ...
        <section className="menu-section section-pad" id="menu" aria-labelledby="menu-title">
          <div className="section-top reveal"><div><p className="eyebrow">01 / SOMETHING GOOD IS COOKING</p><h2 id="menu-title">YOUR USUAL.<br/><span className="text-blush">OR YOUR NEXT.</span></h2></div><p className="section-intro">From your first bite of the morning to your midday escape. There’s more than one way to make your day.</p></div>
        ...
        <section className="place-experience" id="our-place" aria-labelledby="place-title"><div className="room-scene"><div className="room-scene-frame"><img src="/images/Green-room-seating-with-couches.webp" alt="The lush green living wall and seating at Denver Place" width="900" height="1200" loading="lazy"/><div className="room-scene-shade"/><div className="room-scene-top"><span>YOUR CITY. YOUR LITTLE ESCAPE.</span><span>DENVER PLACE / THE GREEN ROOM</span></div><p className="room-scene-title">TAKE A<br/><em>REAL</em> BREAK<span className="room-scene-star" aria-hidden="true">✳</span></p><div className="room-scene-bottom"><span>GOOD FOOD. A CHANGE OF SCENERY.</span><a href="#place-details">COME ON IN <ArrowDown size={18}/></a></div></div></div><div className="place-section section-pad" id="place-details"><div className="place-images reveal"><img className="place-main" src="/images/Green-room-seating-with-couches.webp" alt="The Green room at Denver Place, with a living green wall and cafe seating" width="900" height="1200" loading="lazy"/><div className="place-label">A LITTLE GREEN.<br/>A LITTLE PEACE.</div><img className="place-detail" src="/images/Outside-seating-of-round-table-and-seats.webp" alt="Comfortable booth seating surrounded by curved wooden dividers at Denver Place" width="900" height="1200" loading="lazy"/><span className="image-caption">YOUR TABLE IS WAITING.</span></div><div className="place-copy reveal"><p className="eyebrow">02 / A GOOD PLACE TO LAND</p><h2 id="place-title">STEP OUT.<br/>SETTLE IN.<br/><span className="text-red">STAY A BIT.</span></h2><p>Some days you need a quick bite. Some days you need a real break. You can have both.</p><p>Find us on the ground floor of Denver Place’s North Tower. Grab your favorite, find a seat in the Green room, and let the city carry on for a minute.</p><a className="text-link" href="#visit">Find your way here <ArrowUpRight size={19}/></a><div className="since-lockup"><strong>1997</strong><span>THE YEAR WE STARTED.<br/>STILL YOUR DOWNTOWN SPOT.</span></div></div></div></section>
